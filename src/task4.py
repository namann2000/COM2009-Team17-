...
class colour_search(object):
    ...
    def __init__(self):
        ...
        self.turn_vel_fast = -0.3
        self.turn_vel_slow = -0.04
    ...
    def camera_callback(self, img_data):
        ...
        list_of_colours = ["Dark Blue", "Light Blue", "Green", "Red"]
        list_of_lower= [[115,224,100], [85,76,100], [50,76,100], [-2,200,100]]
        list_of_upper= [[131,260,255],[100,260,255],[75,260,255],[8,260,255]]

        for i in range(len(list_of_colours)):
            lower = list_of_lower[i]
            upper = list_of_upper[i]

            mask = cv2.inRange(hsv_img, tuple(lower), tuple(upper))
